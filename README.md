...
The app always fetches the terminal again immediately before opening the Excel or CSV save
 dialog. This prevents an export from using attendance cached from an earlier fetch. The
 terminal log is never cleared or modified by this tool.
